...
<div class="container-fluid">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form autocomplete="off" class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/AdministradorAjax.php" enctype="multipart/form-data" method="POST" data-form="save"><!--data-form, action y method esta en main.js ----autocomplete es para borrar el cache de los input para que no muestre los elementos que ya se enviaron-->
				<input type="hidden" name="tipoFormulario" value="newAdmin">
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $lc->encriptar(1); ?>">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios2" value="<?php echo $lc->encriptar(2); ?>">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="<?php echo $lc->encriptar(3); ?>" checked="">
