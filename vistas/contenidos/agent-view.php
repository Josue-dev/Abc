		    			...
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" type="text" name="direccion-reg" required="" maxlength="40">
								</div>
		    				</div>
		    				<div class="col-xs-12">
		    					<div class="form-group">
		    						<span class="control-label">Adjuntar DPI ambos lados *</span>
									<input type="file" name="dpi" required="" accept=".jpg, .png, .jpeg .pdf">
		    				...
		    				<div class="col-xs-12">
		    					<div class="form-group">
									...
									<input type="file" name="licencia" required="" accept=".jpg, .png, .jpeg .pdf">
									<div class="input-group">
